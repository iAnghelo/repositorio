<a href="{{ route('institucional.show', ['institucional'=>1]) }}" class="flex items-center w-full my-2 bg-white border border-gray-200 rounded-lg shadow md:flex-row md:w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
