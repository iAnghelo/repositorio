                ...
                <ul id="side-menu">
                    ...
                    <li>
                        <a href="/informes/add"
                            ...
                            <span data-key="t-dashboard">Subir Informe</span>
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="/informes"
                                    class="pl-[52.8px] pr-6 py-[6.4px] block text-[13.5px] font-medium text-gray-950 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">Informes</a>
                            </li>
                            <li>
                                <a href="/informes/publications"
                                    class="pl-[52.8px] pr-6 py-[6.4px] block text-[13.5px] font-medium text-gray-950 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">Publicaciones</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="/manual"
                            class="block py-2.5 px-6 text-sm font-medium text-gray-950 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                            <i data-feather="book-open" fill="#545a6d33"></i>
                            <span data-key="t-dashboard">Manual</span>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="flex items-center topbar-brand">
                <div
                    ...
                    <a href="#"
                        ...
                        <img src="{{ asset('img/logoCSR.jpg') }}" alt=""
                            class="inline-block w-6 h-6 align-middle ltr:xl:mr-2 rtl:xl:ml-2')" />
                        <span style="font-size: 1.05rem !important"
                        ...
                        <div class="relative dropdown">
                            <button type="button"
                                ...
                                <img class="border-[3px] border-gray-700 dark:border-zinc-400 rounded-full w-9 h-9 ltr:xl:mr-2 rtl:xl:ml-2"
                                    src="{{ asset('img/userIcon.png') }}" alt="Header Avatar" />
                                ...
                                <div class="border border-gray-50 dark:border-zinc-600"
                                    ...
                                    <div class="dropdown-item dark:text-gray-100">
                                        <a class="block p-3 hover:bg-gray-50/50 dark:hover:bg-zinc-700/50"
                                            href="#" data-tw-toggle="modal" data-tw-target="#logout-modal"
                                            type="button">
    ...
    <div class="main-content group-data-[sidebar-size=sm]:ml-[70px]">
        <div class="page-content dark:bg-zinc-700">
            <div class="container-fluid px-[0.625rem]">
                ...
                @yield('content')
                @include('components/modal/salir')
